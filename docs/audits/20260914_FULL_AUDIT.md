...
- Phase 9 안전 기능 11개 중 8-16만 구현 완료. 나머지 10개(7-8 부분
  구현 유지, 7-11/7-16/8-5/8-6/8-19/10-4/10-5/10-17/10-18 미착수)는
  각각 독립적인 신규 기능이라 스코핑 문서(`docs/audits/
  20260915_PHASE9_SAFETY_FEATURES_SCOPING.md`)로만 남겼다 — 특히
  10-17/10-18은 외부 회수정보 출처를 사용자가 먼저 지정해야 착수
  가능하다.
