...
class FullChainReplayTestCase(unittest.TestCase):
    ...
    def test_existing_attempt_rows_preserved_and_default_backfilled(self):
        ...
        try:
            ...
            # 2026-09-15 전면 감사 후속 — NEW_MIGRATION 하나만 제외하면
            # 이 파일보다 사전순으로 뒤에 추가된 다른 Migration까지
            # "이전 상태"에 섞여 들어가 OrderInversionError가 난다(9개
            # 이상의 파일에서 반복된 패턴). NEW_MIGRATION과 같거나
